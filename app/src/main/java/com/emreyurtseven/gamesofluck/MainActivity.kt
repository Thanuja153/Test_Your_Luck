...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val coin = GamesModel(0,getString(R.string.head_or_tails),R.drawable.img_coin)
        gamesList.add(coin)

        val dice = GamesModel(1,getString(R.string.dice_roller),R.drawable.img_dice)
        gamesList.add(dice)

        val slotMachine = GamesModel(2,getString(R.string.slot_machine),R.drawable.img_slot_machine)
        gamesList.add(slotMachine)

        val spin = GamesModel(3,getString(R.string.wheels_of_fortune),R.drawable.img_spin)
        gamesList.add(spin)

        val randomNumber = GamesModel(4,getString(R.string.random_number),R.drawable.img_number_seven)
